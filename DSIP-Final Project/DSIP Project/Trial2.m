...
I=double(imread('Pappa.jpeg')); 
In=I; 

mask1=[1, 0, -1;1, 0, -1;1, 0, -1]; %Vertical Edges
mask2=[1, 1, 1;0, 0, 0;-1, -1, -1]; %Horizontal Edges
mask3=[0, -1, -1;1, 0, -1;1, 1, 0]; %Principle Diagonal Elements
mask4=[1, 1, 0;1, 0, -1;0, -1, -1]; %Secondary diagonal Elements
...
for i=2:size(I, 1)-1
	for j=2:size(I, 2)-1
        ...
        %Convolution = I * m where I is the image, m is the mask and * is convolutional operator.
...
figure(1),imshow('Pappa.jpeg');
title('Original Image');

figure(2), imshow(uint8(I)); 
title('Simple edge Detection with no inbuilt functions');